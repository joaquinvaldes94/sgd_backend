...
import cl.nescorp.provider.aplication.service.IndicePresupuestarioService;
import lombok.RequiredArgsConstructor;

@RestController
@RequestMapping("/api/v1/IndicePresupuestario")
@RequiredArgsConstructor
public class IndicePresupuestarioController {

	private final IndicePresupuestarioService service;
	...
	public ResponseDTO save(@RequestBody IndicePresupuestarioDTO request) {
		return service.save(request);
	}

	@PutMapping(path = "/update", consumes = "application/json; charset=utf-8", produces = {
			MediaType.APPLICATION_JSON_VALUE })
	public ResponseDTO update(@RequestBody IndicePresupuestarioDTO request) {
